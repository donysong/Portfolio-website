          ...
          <div class="row">
            <div class="col-xl-6 col-md-6">
              <div class="resume-wrapper wow fadeInUp delay-0-2s">
                ...
                <div class="resume-box">
                  ...
                  <p><a href="https://www.youtube.com/@14FMBC">14F</a> Video Contents</p>
                </div>
            ...
            <div class="col-xl-6 col-md-6">
              <div class="resume-wrapper wow fadeInUp delay-0-4s">
                ...
                <div class="resume-box">
                  <span class="resume-date">2015 - 2022</span>
                  <h2>Bachelor Degree of Business Administration</h2>
                  <span>@ Hankuk University of Foreign Studies</span>
                  <p>Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
